document.addEventListener("alpine:init", () => {
  Alpine.data("menuFilter", () => ({
    ...
    openModal(item) {
      ...
      // Tambahkan state ke riwayat browser
      history.pushState({ modalOpen: true }, "", "#menu-modal");
    },
    ...
    handlePopState(event) {
      // Jika popstate dipicu tanpa modal terbuka, pastikan modal tertutup
      if (!event.state?.modalOpen && this.isModalOpen) {
        this.isModalOpen = false;
        this.modalItem = null;
      }
    },
